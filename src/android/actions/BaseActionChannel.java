...
public abstract class BaseActionChannel extends BaseAction {
    private static final String TAG = "Firebase.BaseActionChannel";

    private static final String TOKEN_CONSTANT = "auth-token";

    protected String mToken;

    BaseActionChannel(int notificationId, Context context, String urlSupplement) {
    ...
    protected void cancelNotification(){
        ...
        NotificationManager.hideChannelSummaryNotificationIfNeed(context, notificationManager);
    }
}
